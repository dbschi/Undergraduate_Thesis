...
For now, give a zeta function proof of huxley and show how to beat huxley at 3/4 
...
\end{proposition}
The continuation of the zeta function is best described by its functional equation: $\zeta$ has a line of symmetry across $\Re (s)=1/2$.
\begin{proposition}
...
\begin{theorem}[Number of zeros of $\zeta$]
